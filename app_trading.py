...
[data-testid="stFileUploader"] {
    border: 1px dashed #1e2740 !important;
    border-radius: 8px !important;
    background: #0d1120 !important;
...
/* ── INFO BOXES (sidebar success/info) ── */
...
with tab_filtros:
    ...
    if not df_historico.empty and st.session_state['mis_tags']:
        ...
        st.info("Aún no hay datos guardados. Procesa un archivo en la pestaña Ingreso primero.")
    else:
        st.info("Aún no hay tags creados. Asigna setups en la pestaña Ingreso primero.")
